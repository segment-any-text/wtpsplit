...
describe('NNSplit', function () {
    ...
    it('should be able to split long text correctly', async function () {
        ...
        assert.deepStrictEqual(split[0].parts.map((x) => x.text), [". ", "Eine Vernetzung von Neuronen im Nervensystem eines Lebewesens darstellen."]);
    });
});
